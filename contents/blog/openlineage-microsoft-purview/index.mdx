...
[Microsoft Purview](https://docs.microsoft.com/en-us/azure/purview/overview) is an ambient data governance solution that helps you unify and manage your data wherever it exists – on-premises, in the cloud, or on a software-as-a-service (SaaS) platform. With Microsoft Purview, you can:
...
Quickly and easily create a [Microsoft Purview](https://azure.microsoft.com/en-us/services/purview/#get-started) account to explore the new features.
