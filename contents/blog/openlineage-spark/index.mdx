...
tools to process raw data in object stores without the dependency on software engineers. A lot of folks were
attracted to its ability to perform multiple operations on data without the I/O overhead of alternatives, like Pig or
Hive, and data scientists were thrilled to start piping that data through their NumPy and Pandas scripts. 
...
Our approach to integrating with Spark is designed to be intuitive and uncomplicated to implement in your systems. Spark
