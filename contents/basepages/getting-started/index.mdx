...
> **Tip:** Pass the `--build` flag to the script to build images from source, or `--pull` to pull a tagged image.
...
<img class="m-12" src="./before-openlineage.svg" />
...
<img class="m-12" src="./with-openlineage.svg" />
