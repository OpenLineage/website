...
[marquez-airflow](https://pypi.org/project/marquez-airflow) is an integration library for sending OpenLineage events to [Marquez](https://marquezproject.ai). The DAG metadata collected can answer questions like:
...
Finally, to begin collecting Airflow DAG metadata with Marquez, use:
...
In this guide, we outlined how the OpenLineage integration works with Airflow. We also walked you through how to install the integration to begin collect DAG metadata.
