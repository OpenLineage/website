...
banner: ./banner.svg
version: 1.10+, 2.0+
datasources: PostgreSQL, MySQL, Snowflake, Amazon Athena, Amazon Redshift, Amazon SageMaker, Amazon S3 Copy and Transform, Google BigQuery, Google Cloud Storage, Great Expectations, SFTP, FTP
