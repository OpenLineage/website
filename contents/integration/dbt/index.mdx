---
title: dbt
description: dbt is a development framework that combines modular SQL with software engineering best practices to make data transformation reliable, fast, and fun. Using dbt with OpenLineage captures metadata about runs and traces lineage relationships between datasets.
image: ./stack.png
banner: ./banner.svg
version: 0.20+
